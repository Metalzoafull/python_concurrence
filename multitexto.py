...
thread_4=threading.Thread(target=crearAnimacion(10,70, 'X'))
thread_5=threading.Thread(target=crearAnimacion(10,90, 'Y'))
thread_6=threading.Thread(target=crearAnimacion(10,110, 'Z'))
