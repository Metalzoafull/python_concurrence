...
if __name__ == '__main__':
    process_1 = multiprocessing.Process(target = crearAnimacion, args = (10,10, 'X'))
    process_2 = multiprocessing.Process(target = crearAnimacion, args = (10,30, 'Y'))
    process_3 = multiprocessing.Process(target = crearAnimacion, args = (10,50, 'Z'))
